...
import 'package:todolistgroup/screens/SettingsScreen.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        AddScreenPage.routeName : (context) => AddScreenPage(),
        SettingsScreenPage.routeName : (context) => SettingsScreenPage(),
      },
    );
  }
}
